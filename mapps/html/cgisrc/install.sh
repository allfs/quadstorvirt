...
mkdir -p $QUADSTOR_ROOT/httpd/www/quadstor
mkdir -p $QUADSTOR_ROOT/httpd/cgi-bin/
if [ ! -d $QUADSTOR_ROOT/httpd/www/quadstor/yui ]; then
	cp -r yui $QUADSTOR_ROOT/httpd/www/quadstor/
fi

cp -f *.png $QUADSTOR_ROOT/httpd/www/quadstor
cp -f *.js $QUADSTOR_ROOT/httpd/www/quadstor
cp -f *.css $QUADSTOR_ROOT/httpd/www/quadstor
cp -f index.html $QUADSTOR_ROOT/httpd/www/
