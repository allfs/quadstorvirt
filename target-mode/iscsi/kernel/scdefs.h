...
int iscsi_target_new_device_cb (struct tdisk *newdevice);
int iscsi_target_remove_device_cb(struct tdisk *removedevice, int tid, void *hpriv);
void iscsi_target_disable_device_cb(struct tdisk *removedevice, int tid, void *hpriv);
