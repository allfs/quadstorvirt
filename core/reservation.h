...
int persistent_reservation_handle_register(struct tdisk *tdisk, struct qsio_scsiio *ctio);
int persistent_reservation_handle_register_and_ignore(struct tdisk *tdisk, struct qsio_scsiio *ctio);
int persistent_reservation_handle_reserve(struct tdisk *tdisk, struct qsio_scsiio *ctio);
int persistent_reservation_handle_release(struct tdisk *tdisk, struct qsio_scsiio *ctio);
int persistent_reservation_handle_clear(struct tdisk *tdisk, struct qsio_scsiio *ctio);
int persistent_reservation_handle_preempt(struct tdisk *tdisk, struct qsio_scsiio *ctio, int abort);
struct reservation_spec {
	uint32_t generation;
	uint8_t  is_reserved;
	uint8_t  type;
...
void registration_spec_add(struct tdisk *tdisk, struct reservation *reservation, struct registration_spec *registration_spec);
void registration_spec_clear(struct tdisk *tdisk, struct reservation_spec *reservation_spec);
void registration_spec_modify(struct tdisk *tdisk, struct registration_spec *registration_spec);
void registration_spec_remove(struct tdisk *tdisk, struct reservation *reservation, struct registration_spec *registration_spec);
void reservation_spec_fill(struct reservation *reservation, struct reservation_spec *reservation_spec);
void reservation_spec_copy(struct reservation *reservation, struct reservation_spec *reservation_spec);
enum {
	REGISTRATION_OP_ADD,
	REGISTRATION_OP_DELETE,
	REGISTRATION_OP_MODIFY,
};
