...
struct amap_table * amap_table_load_async(struct tdisk *tdisk, uint64_t block, struct amap_table_group *group, uint32_t group_id, uint32_t group_offset, int atable_id);
int amap_table_init(struct tdisk *tdisk, struct amap_table_group *group, uint32_t group_offset, int atable_id, struct index_info_list *meta_index_info_list);
...
struct amap_table * amap_table_alloc(struct tdisk *tdisk, uint32_t amap_table_id, uint32_t group_offset);
struct amap_table * amap_table_load(struct tdisk *tdisk, uint64_t block, struct amap_table_group *group, uint32_t group_offset, int atable_id, struct tpriv *priv);
void amap_table_insert(struct amap_table_group *group, struct amap_table *amap_table, uint32_t group_offset);
